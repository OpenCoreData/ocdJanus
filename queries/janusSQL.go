...
// var var Sql_samples string

var Sql_chemcarb string = ` select x.leg, x.site, x.hole, x.core, x.core_type,
...
var Sql_roundSumTotalCore string = ` select c.leg
     , c.site
     , c.hole
     , c.core
     , c.core_type
...
var Sql_sampleCount string = ` select x.leg, x.site, x.hole, x.core, x.core_type,
  x.section_number, x.section_type,
  s.top_interval * 100.0, s.bottom_interval * 100.0,
...
var Sql_MSL_SECTION_COUNT string = `select x.leg, x.site, x.hole, x.core, x.core_type,
...
var Sql_NGR_SECTION_COUNT string = ` select x.leg, x.site, x.hole, x.core, x.core_type,
  x.section_number, x.section_type,
...
var Sql_PWL_SECTION_COUNT string = ` select x.leg, x.site, x.hole, x.core, x.core_type,
  x.section_number, x.section_type,
...
var Sql_PWS_SECTION_COUNT string = ` select
 x.leg
 , x.site
 , x.hole
 , x.core
...
var Sql_MAD_SAMPLE_COUNT string = ` (select x.leg, x.site, x.hole, x.core, x.core_type,
  x.section_number, x.section_type,
  s.top_interval * 100.0, s.bottom_interval * 100.0,
...
var Sql_SHEAR_STRENGTH_COUNT string = ` select
 x.leg
 , x.site
 , x.hole
 , x.core
...
var Sql_MS2F_SECTION_COUNT string = ` select x.leg, x.site, x.hole, x.core, x.core_type,
...
var Sql_DHT_APCT_RUN_COUNT string = ` select
  dar.apct_leg,
  dar.apct_site,
  dar.apct_hole,
  dar.apct_core,
...
var Sql_SPLICER_COUNT string = ` select
 lb.leg
 , lb.site
 , lb.sort_key
 , lb.hole_end
...
var Sql_TENSOR_CORE_COUNT string = ` select rez.leg, rez.site,
  rez.hole, rez.core,
  rez.core_type,
...
var Sql_PALEO_SAMPLE_COUNT string = ` select
 fg.fossil_group,
...
var Sql_AGEPROFILE_COUNT string = ` select
 ap.leg
 , ap.site
 , ap.hole
...
var Sql_AGE_DATAPOINT_COUNT string = ` select
...
var Sql_XRD_IMAGE_COUNT string = ` select
 x.leg
 , x.site
 , x.hole
 , x.core
...
var Sql_XRF_SAMPLE_COUNT string = ` SELECT xsa.sample_id,
  x.leg, x.site, x.hole, x.core, x.core_type,
  nvl(decode(section_type,'C','CC ', to_char(x.section_number,'90')), ' '),
...
var Sql_ICP_SAMPLE_COUNT string = ` SELECT xsa.sample_id,
  x.leg, x.site, x.hole, x.core, x.core_type,
  nvl(decode(x.section_type,'C','CC ', to_char(x.section_number,'90')), ' '),
  s.top_interval*100.0, s.bottom_interval * 100.0,
  nvl(get_depths(x.section_id, 'STD', s.top_interval,0,0),-1),
...
var Sql_SMEAR_SLIDE_COUNT = ` select
...
var Sql_SED_THIN_SECT_COUNT string = ` select cn.sts_component_name_code, cn.sts_component_type_code, cn.sts_component_name,
...
var Sql_HRTHIN_COUNT string = ` select /*+ star */ x.leg
 , x.site
 , x.hole
 , x.core
 , x.core_type
...
var Sql_VCD_IMAGE_COUNT string = ` select
 x.leg
 , x.site
 , x.hole
 , x.core
...
var Sql_CORE_IMAGES_COUNT string = ` select
  ci.leg,
  ci.site,
  ci.hole,
  ci.core,
...
var Sql_CORE_SECTION_IMAGES_COUNT string = ` select
  ci.leg,
  ci.site,
  ci.hole,
  ci.core,
